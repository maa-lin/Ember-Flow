    ...
    <div className={styles.overlay}>
      ...
      >
        ...
        <div className={styles["scroll-wrapper"]}>
          ...
          <p>
            Let <strong>Ember Flow</strong> be your calm companion, encouraging
            gentle progress and mindful moments, so you can flow through your
            day with ease and presence.
          </p>

          <details>
            <summary style={{ boxShadow: currentTheme.shadowS }}>
              <span>
                <FaPagelines /> What is mindfullness?
              </span>
              <FaChevronDown className={styles.chevron} />
            </summary>
            <p>
              Mindfulness is the practice of paying attention to the{" "}
              <strong>present moment</strong> — your thoughts, feelings, and
              surroundings without judgment.
            </p>
            <p>
              It helps you slow down, notice what you need, and make more
              intentional choices instead of running on autopilot. Even a few
              mindful moments can bring <strong>clarity and calm</strong> to
              your day.
            </p>
          </details>
          ...
          <details>
            <summary style={{ boxShadow: currentTheme.shadowS }}>
              <span>
                <FaBookOpen /> How to use Ember Flow
              </span>
              <FaChevronDown className={styles.chevron} />
            </summary>
            <p>
              Each day, you’ll see two short lists;{" "}
              <strong>things to focus on</strong> and{" "}
            ...
            <p>
              The <strong>daily challenge</strong> is optional. Try it if you
              feel like it, or skip it — a new one will be waiting for you
              tomorrow.
            </p>
            <p>
